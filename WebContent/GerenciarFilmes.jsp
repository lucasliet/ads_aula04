                ...
                <div class="col-md-6">
                    <form action="manter_filmes.do" method="GET" class="card m-3 rounded shadow">
                        <div class="card-header bg-dark text-white p-3">
                            <h1>Exibir Filme</h1>
                            <p>Selecione um Filme para mostrar seus dados</p>
                        </div>
            ...
            <form action="manter_filmes.do" method="POST" class="card m-3 rounded shadow">
                ...
                <div class="cad-body p-3">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="descricao" placeholder="A FedEx executive undergoes a physical and emotional transformation after crash landing on a deserted island. ">
                        </textarea>
                    </div>
                    <div class="form-row">
