			...
			<form action="manter_filmes.do" method="POST" class="card my-3 rounded shadow bg-light">
				...
				<div class="card-body p-3">
								...
								<div class="form-group col-sm-12 col-md-6">
									...
									<div class="input-group">
										...
										<input type="date" class="form-control" name="data"
											value="${filme.dataLancamento}" required>
									</div>
								</div>
								<div class="form-group col-sm-12 col-md-6">
									...
									<div class="input-group">
										...
										<input type="number" class="form-control" name="popularidade" max=1000
											value="${filme.popularidade}" required>
									</div>
								</div>
							</div>
							<div class="form-row">
								...
								<div class="form-group col-sm-12 col-md-6">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" name="posterpath"
											value="${filme.posterPath}" required>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text" id="basic-addon1"> <i class="fas fa-file-alt"></i>
								</span>
							</div>
							<textarea type="text" class="form-control" name="descricao" rows=3
								required>${filme.descricao}</textarea>
						</div>
					</div>
					<div class="text-right">
						<button type="submit" name="acao" value="btn-atualizar"
