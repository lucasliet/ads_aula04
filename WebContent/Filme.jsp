...
<body>
    <header>
        ...
        <div class="bg-dark cbg-rolo text-white text-center p-2">
            <h1 class="text-bold text-uppercase ctext-shadow ">🍿Filme🍿</h1>
        </div>
    </header>
    <div class="container">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-sm-4 col-lg-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" name="id_excluir" value="${filme.id}" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-sm-12 col-md-6">
                                            ...
                                            <div class="input-group ">
                                                ...
                                                <p class="form-control" id="genero">${filme.genero.nome}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
